...
def load_models():
    ...
    relu_128_16 = torch.load('LeakyReLU(negative_slope=0.01)_EMB128_Context16.pth')
    ...
    relu_128_32 = torch.load('LeakyReLU(negative_slope=0.01)_EMB128_Context32.pth')
    ...
    relu_256_16 = torch.load('LeakyReLU(negative_slope=0.01)_EMB256_Context16.pth')
    ...
    relu_256_32 = torch.load('LeakyReLU(negative_slope=0.01)_EMB256_Context32.pth')
    ...
    tanh_128_16 = torch.load('Tanh()_EMB128_Context16.pth')
    ...
    tanh_128_32 = torch.load('Tanh()_EMB128_Context32.pth')
    ...
    tanh_256_16 = torch.load('Tanh()_EMB256_Context16.pth')
    ...
    tanh_256_32 = torch.load('Tanh()_EMB256_Context32.pth')
